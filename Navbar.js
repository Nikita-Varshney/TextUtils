...
export default function Navbar(props) {
  return (
    <nav className={`navbar navbar-expand-lg bg-${props.mode==='light'?'success':'dark'} bg-gradient bg-opacity-25`}>
        ...
        <div className="collapse navbar-collapse mx-2"id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 ">
            ...
            <div className="form-check form-switch">
              ...
              />
              <label className={`form-check-label my-1 fw-semibold text-${props.mode==='light'?'dark':'light'}`} for="flexSwitchCheckChecked">Dark Mode</label>
            </div> 
        </div>
      </div>
    </nav>
